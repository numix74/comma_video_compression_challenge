...
PYTHON="/home/amogh/.local/share/uv/python/cpython-3.11.15-linux-x86_64-gnu/bin/python3.11"
VENV_SP="${PD}/.venv/lib/python3.11/site-packages"
export IN_DIR ARCHIVE_DIR PD PYTHONPATH="${PD}:${VENV_SP}"
